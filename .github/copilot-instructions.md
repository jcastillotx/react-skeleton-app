...
| 2 | Which stack is required: Laravel app, Next.js app, or WordPress plugin? |
| 3 | Where is the deployment target: WHM AWS LAMP server, Vercel, or existing React server? |
| 4 | What is in scope vs. explicitly out of scope? |
| 5 | Are there constraints (deadlines, tech choices, must-not-change areas)? |
| 6 | What are the acceptance criteria and how will we verify success? |
| 7 | What tests or checks are expected? |
